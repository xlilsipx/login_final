...
class SignInPage2 extends StatefulWidget {
  /// The page title.
  final String title = 'Sign In mit dem bums';

  @override
  State<StatefulWidget> createState() => _SignInPage2State();
}
      ...
      child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                alignment: Alignment.center,
                child: const Text('Social Media und co',
                    style: TextStyle(fontWeight: FontWeight.bold)),
              ),
              // Container(
              //   padding: const EdgeInsets.only(top: 16),
